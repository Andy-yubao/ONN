"""Photoconductive time-to-first-spike encoder, unchanged from the MLP baseline."""
...
class DeviceLatencyEncoder:
    ...
    def first_spike_times(self, pixels: torch.Tensor) -> torch.Tensor:
        """Return times in [0, T-1], or -1 when threshold is never reached."""
    ...
    def encode(self, images: torch.Tensor) -> torch.Tensor:
        """Encode [B, 1, 8, 8] images as [T, B, 1, 8, 8] spikes."""
